...
::A7M unpacking
START /W /B RdaConsole ^extract -f %island_name%.a7m -o %island_name% -y
...
START /W /B FileDBReader decompress -f rd3d.data -i ../../Island_RD3D.xml -y 
MOVE /Y rd3d.xml rd3d_original.xml

START /W /B FileDBReader decompress -f gamedata.data -i ../../Island_Gamedata.xml -y 
...
::A7MINFO unpacking
START /W /B FileDBReader decompress -f %island_name%.a7minfo -y -i ../a7minfo.xml
